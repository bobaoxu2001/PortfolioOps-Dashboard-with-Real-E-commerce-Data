...
def _greater_than_or_equal(value: Any, threshold: float) -> bool:
    numeric_value = _finite_float(value)
    return numeric_value is not None and numeric_value >= threshold


def _between_inclusive(value: Any, lower: float, upper: float) -> bool:
    numeric_value = _finite_float(value)
...
def main(repo_root: pathlib.Path | None = None) -> None:
    ...
    add_test(
        ...
        _greater_than_or_equal(delivered_logic_coverage, 0.995),
        ">= 0.995",
    ...
    add_test(
        ...
        "warning",
        cancellation_rate,
        _between_inclusive(cancellation_rate, 0.0, 0.2),
        "between 0 and 0.20",
    ...
    add_test(
        ...
        "warning",
        on_time_coverage,
        _greater_than_or_equal(on_time_coverage, 0.90),
        ">= 0.90",
    ...
    add_test(
        ...
        "warning",
        payment_gmv_ratio,
        _between_inclusive(payment_gmv_ratio, 0.90, 1.15),
