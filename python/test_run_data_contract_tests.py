        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            conn.execute(
                ...
                INSERT INTO marts.fact_orders VALUES
                    ('order_1', 'customer_1', 'delivered', 10.0, 10.0, 1, 0, 1, 5.0, 10.0),
                    ('order_2', 'customer_2', 'delivered', 20.0, 20.0, 1, 0, 0, 3.0, 20.0)
                """
            )
            conn.execute(
                """
            ...
            conn.execute(
                ...
                INSERT INTO marts.fact_order_items VALUES
                    ('order_1', 1, 'product_1', 10.0),
                    ('order_2', 1, 'product_2', 20.0)
                """
            )
            ...
            self.assertEqual(0.0, leakage_result["observed_value"])
